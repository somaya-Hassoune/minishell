...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/12/12 19:08:35 by szine-            #+#    #+#             */
/*   Updated: 2023/12/13 11:10:24 by szine-           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char	*get_next_line(int fd)
{
	...
	line[fd] = get_ligne(fd, line[fd]);
	if (!line[fd])
	{
		return (NULL);
	}
	str = set_return(line[fd]);
	line[fd] = set_line_again(line[fd]);
	return (str);
}
